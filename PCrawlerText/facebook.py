...
fb_username = "13918162228"
fb_password = "720312xy"
fb_name = "Melissa Chan"
fb_myid = "1578111929166609"
...
class Facebook(object):
    ...
    def getAccessToken(self):
        ...
        res = re.findall(r"""Friends: <a href=\"https://graph.facebook.com/me?access_token=(.+?)\">""", data)
        if len(res) < 1:
